<template>
  <div :class="$style.messageItem">
    <div :class="$style.messageItemContainer">
      <image-lazy
        :class="$style.messageItemContainerAvatar"
      ...
      <div :class="$style.messageItemContainerContent">
        ...
        <div
          :class="$style.messageItemContainerReply"
          v-highlight
          v-html="message.reply.content"
        ></div>
        <div :class="$style.messageItemContainerTime">
          {{ ago(message.create_at) }}
        </div>
      </div>
    </div>
  </div>
